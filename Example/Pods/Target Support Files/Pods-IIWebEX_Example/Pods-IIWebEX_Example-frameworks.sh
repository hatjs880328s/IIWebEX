...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IIAOPNBP/IIAOPNBP.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IIHTTPRequest/IIHTTPRequest.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IIWebEX/IIWebEX.framework"
