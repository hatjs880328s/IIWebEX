...
class AOPNotificaitonCenter: NSObject {
    ...
    @discardableResult
    public static func getInstance() -> AOPNotificaitonCenter {
    ...
    private func addNotificationNames() {
        ...
        self.notiNames[AOPEventType.webviewRequest.rawValue] = Notification.Name.InspurNotifications().webvwRequest
    }
    ...
    private func monitorNotifications() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.progressCenter(noti:)), name: self.notiNames[AOPEventType.webviewRequest.rawValue], object: nil)
    }
