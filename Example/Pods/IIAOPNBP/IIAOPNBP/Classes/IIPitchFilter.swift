...
public class IIPitchFilter: NSObject {
    ...
    @objc public static var filterArr: [String] = ["TABLESwizzing", "VCSwizzing", "ApplicitonSwizzing", "Aspect", "AOPNBPCoreManagerCenter", "GodfatherSwizzingPostnotification", "AOPNotificaitonCenter", "SnapKit", "JPush", "JPUSH", "IFly", "UMSocial", "AppDelegate", "AMap", "SD", "MJ", "OOP", "__", "Aspect", "TraverseCoreOBJC", "IIPitchFilter", "IITraverseUtility", "CleanKeychain", "WCT", "RCT", "FM", "AOPMmapOCUtility", "String", "NSDate", "AFN", "NSUUID", "SessionDelegate", "UIControl", "Connectivity"]
    
    /// ignore shouldn't progress methods  [mj start...]
    @objc public static var filterFunctionArr: [String] = ["init", "startServices", "cxx_destruct", "AnalyzeNetWorkWithNoti", "description", "heightForRowAt", "numberOfRowsInSection", "cellForRowAt", "didSelectRowAt", "numberOfSections", "mj", "heightForHeaderInSection", "heightForFooterInSection", "viewForHeaderInSection", "viewForFooterInSection", "didReceiveWSResponse", "getMessageDicByResponseDic", "setLocalSessions", "localSessions"]
